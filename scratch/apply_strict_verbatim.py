...
def apply_strict_verbatim():
    print("=== APPLYING 100% STRICT VERBATIM USER TRANSCRIBED QUESTIONS AND ANSWERS ===")
    ...
    print("Successfully registered 100% strict verbatim questions and answers!")

    import clean_and_export_quiz
    clean_and_export_quiz.clean_and_export()

if __name__ == "__main__":
    apply_strict_verbatim()
