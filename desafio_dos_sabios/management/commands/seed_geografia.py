...
class Command(BaseCommand):
    help = 'Seeds Geography AV1 questions into the database.'
    ...
    def handle(self, *args, **options):
        ...
        questions_data = [
            ...
            {
              "topic": "Região Sul do Brasil",
              "question": "Qual país fica ao sol do Brasil e faz fronteira com o Rio Grande do Sul?",
        ...
        self.stdout.write(self.style.SUCCESS(f"Sucesso! {count} questões de Geografia (AV1) foram processadas."))
