        ...
        {ITEMS.map((it) => {
          return (
            <Link
              key={it.href}
              href={it.href}
               className="flex flex-1 select-none flex-col items-center gap-0.5 py-2.5 text-[11px] font-bold transition active:scale-95 sm:flex-none sm:rounded-full sm:px-4 text-white"
            >
