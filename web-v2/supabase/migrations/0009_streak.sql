-- ============================================================
-- 0009 — Ofensiva (streak diário) + medalhas de ofensiva/gabarito.
-- award_arks passa a manter o streak e conceder medalhas por marco.
-- Mesma assinatura/retorno de 0008. Idempotente (drop+create).
-- ============================================================
...
begin
  ...
  -- Ofensiva: hoje já contou → mantém; ontem → +1; senão → reinicia em 1.
  ...
  -- Medalhas: boas-vindas, gabarito e marcos de ofensiva.
